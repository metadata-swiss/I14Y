...
internal static class IopConceptMappingExtensions
{
        ...
        IEnumerable<ConceptReferenceModel>? isReplacedBy = null)
    {
        ...
        return new()
        {
            CodeListEntries = iopConcept.CodeListEntries?.Select(c => c.MapToCodeListEntryModel()),
            ...
            ConformsTo = iopConcept.ConformsTo.Select(r => r.MapToResourceModel()),
            ...
            Keywords = iopConcept.Keywords.Select(k => k.MapToKeywordModel()),
            ...
            Themes = themesVocabulary != null ? iopConcept.Themes.MapToVocabularyEntryModels(themesVocabulary) : [],
