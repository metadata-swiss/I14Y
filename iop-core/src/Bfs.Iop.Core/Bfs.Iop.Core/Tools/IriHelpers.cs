...
/// <summary>
/// Host-agnostic helpers for parsing i14y IRIs. Mirrors the frontend's
/// <c>src/app/shared/iri-helpers.ts</c>.
/// <para>
/// IRIs may have been produced against any environment (DEV, ABN, PROD), so
/// these helpers intentionally don't depend on the configured base URL — they
/// match on the well-known path structure (<c>/concept/…</c>, <c>/version/…</c>) only.
/// </para>
/// </summary>
