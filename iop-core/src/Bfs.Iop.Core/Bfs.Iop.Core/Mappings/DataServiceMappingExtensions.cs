...
internal static class DataServiceMappingExtensions
{
        ...
        IVocabulariesService vocabulariesService)
    {
        ...
        return new()
        {
            ...
            EndpointDescriptions = entity.EndpointDescription.Select(x => x.MapToResourceModel()),
            EndpointUrls = entity.EndpointUrl.Select(x => x.MapToResourceModel()),
            Id = entity.Id,
            ...
            ServesDatasets = entity.Datasets.Select(x => x.MapToIdModel()),
