...
11. Execute this README regeneration in one autonomous run: gather evidence, edit, and self-check without pausing for intermediate confirmation when evidence is sufficient.
