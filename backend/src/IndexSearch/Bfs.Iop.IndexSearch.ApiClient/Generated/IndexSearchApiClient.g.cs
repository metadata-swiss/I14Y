...
namespace Bfs.Iop.IndexSearch.ApiClient
{
    ...
    public partial interface IIndexSearchApiClient
    {
        /// <returns>Accepted</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SwaggerResponse<IndexStatusResponse>> PostIndexReindexAsync();

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Accepted</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SwaggerResponse<IndexStatusResponse>> PostIndexReindexAsync(System.Threading.CancellationToken cancellationToken);

        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SwaggerResponse<IndexStatusResponse>> GetIndexStatusAsync();
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SwaggerResponse<CatalogSearchHitPagedResult>> GetSearchCatalogByQueryAndLanguageAndPageAndPageSizeAsync(string query, string language, int? page, int? pageSize, System.Threading.CancellationToken cancellationToken);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SwaggerResponse<CatalogFacetCounts>> GetSearchCatalogFacetsByQueryAndLanguageAsync(string query, string language, System.Threading.CancellationToken cancellationToken);
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    internal partial class IndexSearchApiClient : Bfs.Iop.Infrastructure.ApiClient.NewtonsoftJson.NewtonsoftJsonWebApiClientBase, IIndexSearchApiClient
    {
        private static System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(CreateSerializerSettings, true);
        private Newtonsoft.Json.JsonSerializerSettings _instanceSettings;

    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public IndexSearchApiClient(Bfs.Iop.Infrastructure.ApiClient.NewtonsoftJson.INewtonsoftJsonClientSupport configuration) : base(configuration)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>Accepted</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SwaggerResponse<IndexStatusResponse>> PostIndexReindexAsync()
        {
            return PostIndexReindexAsync(System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Accepted</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SwaggerResponse<IndexStatusResponse>> PostIndexReindexAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = await CreateHttpRequestMessageAsync(cancellationToken).ConfigureAwait(false))
                {
                    ...
                    // Operation Path: "api/index/reindex"
                    urlBuilder_.Append("api/index/reindex");
                    ...
                    try
                    {
                        ...
                        if (status_ == 202)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<IndexStatusResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SwaggerResponse<IndexStatusResponse>> GetIndexStatusAsync()
        {
            return GetIndexStatusAsync(System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SwaggerResponse<IndexStatusResponse>> GetIndexStatusAsync(System.Threading.CancellationToken cancellationToken)
        {
            var client_ = await CreateHttpClientAsync(cancellationToken).ConfigureAwait(false);
            var disposeClient_ = true;
            try
            {
                using (var request_ = await CreateHttpRequestMessageAsync(cancellationToken).ConfigureAwait(false))
                {
                    ...
                    // Operation Path: "api/index/status"
                    urlBuilder_.Append("api/index/status");
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SwaggerResponse<CatalogSearchHitPagedResult>> GetSearchCatalogByQueryAndLanguageAndPageAndPageSizeAsync(string query, string language, int? page, int? pageSize)
        {
            return GetSearchCatalogByQueryAndLanguageAndPageAndPageSizeAsync(query, language, page, pageSize, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SwaggerResponse<CatalogSearchHitPagedResult>> GetSearchCatalogByQueryAndLanguageAndPageAndPageSizeAsync(string query, string language, int? page, int? pageSize, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = await CreateHttpClientAsync(cancellationToken).ConfigureAwait(false);
            var disposeClient_ = true;
            try
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SwaggerResponse<CatalogFacetCounts>> GetSearchCatalogFacetsByQueryAndLanguageAsync(string query, string language, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = await CreateHttpClientAsync(cancellationToken).ConfigureAwait(false);
            var disposeClient_ = true;
            try
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SwaggerResponse<CodeListSearchHitPagedResult>> GetSearchCodelistsByConceptIdAndQueryAndLanguageAndPageAndPageSizeAsync(System.Guid conceptId, string query, string language, int? page, int? pageSize)
        {
            return GetSearchCodelistsByConceptIdAndQueryAndLanguageAndPageAndPageSizeAsync(conceptId, query, language, page, pageSize, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SwaggerResponse<CodeListSearchHitPagedResult>> GetSearchCodelistsByConceptIdAndQueryAndLanguageAndPageAndPageSizeAsync(System.Guid conceptId, string query, string language, int? page, int? pageSize, System.Threading.CancellationToken cancellationToken)
        {
            if (conceptId == null)
            ...
            try
            {
                using (var request_ = await CreateHttpRequestMessageAsync(cancellationToken).ConfigureAwait(false))
                {
                    ...
                    // Operation Path: "api/search/codelists/{conceptId}"
    ...
    public partial class CatalogSearchHitPagedResult
    {
        ...
        public System.Collections.Generic.ICollection<CatalogSearchHit> Results { get; set; }
    ...
    public partial class CodeListSearchHitPagedResult
    {
        ...
        [Newtonsoft.Json.JsonProperty("results", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<CodeListSearchHit> Results { get; set; }
