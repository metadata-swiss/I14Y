...
internal static class ModelToDocumentMapping
{
    ...
    private static CatalogIndexDocument WithPublishableFields(
        ...
        IPublishableEntityModel model) =>
        document with
        {
            PublisherId = model.Publisher?.Id ?? Guid.Empty,
            PublisherIdentifier = model.Publisher?.Identifier,
            PublicationLevel = model.PublicationLevel,
            PublicationLevelProposal = model.PublicationLevelProposal,
            RegistrationStatus = model.RegistrationStatus,
            RegistrationStatusProposal = model.RegistrationStatusProposal,
            CreatedAt = model.System.CreatedAt,
            ModifiedAt = model.System.ModifiedAt,
            CreationType = model.System.CreationType ?? CreationType.Manual,
        };
