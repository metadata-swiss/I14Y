...
internal sealed class DatasetsService : PublishableEntityServiceBase<Dataset>, IDatasetsService
{
    ...
    public async Task<DcatDatasetModel> GetDataset(string identifier, CancellationToken cancellationToken)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new PagedResult<DcatDatasetModel>()
        {
            ...
            Results = results.Select(x => x.MapToDcatDatasetModel(_vocabulariesService)).ToList().AsReadOnly(),
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new PagedResult<DatasetQualityQuestionModel>()
        {
            ...
            Results = results.Select(x => x.MapToDatasetQualityQuestionModel()).ToList().AsReadOnly(),
    ...
    public async Task<DatasetQualityInformationDataModel> GetDatasetQualityInformation(Guid id, CancellationToken cancellationToken = default)
    {
        ...
        {
            DatasetId = id,
            Documentation = links.Select(x => x.MapToDatasetQualityInformationLinkModel()).ToList(),
            QualityInformations = qualityInformations.Select(x => x.MapToDatasetQualityInformationModel()).ToList()
        };
    }
