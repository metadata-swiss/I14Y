...
internal static class PublicServiceMappingExtensions
{
        ...
        IVocabulariesService vocabulariesService)
    {
        ...
        return new()
        {
            BusinessEvents = entity.BusinessEvents.MapToVocabularyEntryModels(businessEventsVocabulary).ToList(),
            Channels = entity.Channels.Select(x => x.MapToChannelModel(vocabulariesService)).ToList(),
            Description = entity.Description.MapToMultiLanguageModel(),
            Id = entity.Id,
            Identifiers = entity.Identifiers,
            IsDescribedAt = entity.IsDescribedAt.Select(x => x.MapToIdModel()).ToList(),
            ...
            LifeEvents = entity.LifeEvents.MapToVocabularyEntryModels(lifeEventsVocabulary).ToList(),
            ...
            Relations = entity.Relation.Select(x => x.MapToIdModel()).ToList(),
            Requires = entity.Requires.Select(x => x.MapToIdModel()).ToList(),
