...
public sealed class IopJsonSerializer
{
    ...
    public static Stream Serialize<T>(T data) where T : class
    {
        ...
        where T : class
    {
        ...
        var wrappedEntries = JsonSerializer.Deserialize<DataWrapper<T>>(
            ...
            throw new FileLoadException("The content of the file could not be read.");
        ...
        where T : class
    {
        ...
        var wrappedEntries = JsonSerializer.Deserialize<DataWrapper<T>>(
            ...
            GetDefaultOptions(
                ignoreGuidType: false,
                setRequiredPropertiesToDefaultValueIfNull: setRequiredPropertiesToDefaultValueIfNull)) ??
            throw new FileLoadException("The content of the string could not be read.");
