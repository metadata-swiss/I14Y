...
/// </summary>
internal sealed class SortedRdfXmlWriter : BaseRdfWriter, IPrettyPrintingWriter, IDtdWriter, INamespaceWriter, IFormatterBasedWriter
{
    private readonly ITripleSorter _sorting;

    public SortedRdfXmlWriter(ITripleSorter sorting)
    {
