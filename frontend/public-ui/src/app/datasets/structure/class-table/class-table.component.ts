import {Input, Output, EventEmitter, Component, inject, OnInit, OnDestroy} from '@angular/core';
...
export class ClassTableComponent implements OnInit, OnDestroy {
	...
	selectProperty(selectedProperty: SchemaProperty): void {
		this.propertySelected.emit(selectedProperty);
	}
